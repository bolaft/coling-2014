...
This paper addresses the problem of rhetorically segmenting messages in online discussions. The process aims at supporting the analysis of messages in terms of dialogues acts.
...
Our idea is to use this effort, in particular the one of the writer who replies to a message by inserting his response or comment just after the quoted text appropriate to his intervention. 
%
...
The so built segmentation model will be then applied on new contents and be so usable for any posting styles.
