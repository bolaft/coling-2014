...
Indeed, because of some email software clients involved in the discussion %handle the messages in a discussion 
...
% are identified based on the presence of a specific prefix at the beginning of the lines. 
 As declared in the RFC~3676\footnote{\url{http://www.ietf.org/rfc/rfc3676.txt}}, we consider as \textit{quoted lines}, the lines of a message beginning with %to be quoted if the first character is 
